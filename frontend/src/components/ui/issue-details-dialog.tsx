...
import type { IssueDetail } from "@/features/pricing/issues";

export type { IssueDetail } from "@/features/pricing/issues";

type IssueSkuTag = NonNullable<IssueDetail["skuTags"]>[number];
